...
class RvizViewer:
    def __init__(self):
        ...
        if setting_file_path == '':
            print("Rviz viewer: no setting file path is given, using default setting files --" + default_setting_file_path)
        ...
        print('open urdf file location', path_to_src + '/configs/urdfs/' + settings["urdf"])
