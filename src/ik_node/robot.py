...
import PyKDL
from src.ik_node.custom_kdl_parser import kdl_tree_from_urdf_model
import yaml

class Robot():
    def __init__(self, setting_path = None):
        package_dir = os.path.dirname(os.path.abspath(__file__)) + '/../../'
        setting_file_path = package_dir + '/configs/settings.yaml'
        if setting_path != '':
        ...
        self.robot = URDF.from_xml_file(package_dir + "/configs/urdfs/" + urdf_name)
